...
public class Main
{
    public static void main(String[] args)
    {
        ...
        // CONTAINS
        li.contains(3); // igual que el de cadenas
        ...
        // CONVIERTE UN ARRAY EN LISTA Y VICEVERSA
        int[] a = {1, 2, 3};
        List<Integer> l = Arrays.stream(a).boxed().collect(Collectors.toList());    // Array en Lista

        Integer[] b = new Integer[l.size()];
        b = l.toArray(b);                                                           // Lista en Array
    }
