...
//        c.insertaVideojuego(new Videojuego("Red Dead Redemption 2", 2018,
//                Plataforma.PlayStation_4, TipoJuego.Aventura, 96));
//        c.insertaVideojuego(new Videojuego("Half-Life 2", 2004,
//                Plataforma.PC, TipoJuego.Accion, 95));
//        c.insertaVideojuego(new Videojuego("Super Smash Bros. Ultimate", 2018,
//                Plataforma.Switch, TipoJuego.Accion, 92));
//        c.insertaVideojuego(new Videojuego("Fallout 4", 2015,
//                Plataforma.Xbox_One, TipoJuego.Rol, 89));
